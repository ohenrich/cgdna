...
PairStyle(oxdna_xstack,PairOxdnaXstack)

#else

#ifndef LMP_PAIR_OXDNA_XSTACK_H
#define LMP_PAIR_OXDNA_XSTACK_H

#include "pair.h"

namespace LAMMPS_NS {

class PairOxdnaXstack : public Pair {
 public:
  PairOxdnaXstack(class LAMMPS *);
  virtual ~PairOxdnaXstack();
